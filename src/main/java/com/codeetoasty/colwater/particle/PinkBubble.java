...
public class PinkBubble extends SpriteBillboardParticle {
    private PinkBubble(ClientWorld world, double x, double y, double z, double d, double e, double f) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            com.codeetoasty.colwater.particle.PinkBubble PinkBubble = new com.codeetoasty.colwater.particle.PinkBubble(clientWorld, d, e, f, g, h, i);
            PinkBubble.setSprite(this.spriteProvider);
            return PinkBubble;
        }
    }
}
