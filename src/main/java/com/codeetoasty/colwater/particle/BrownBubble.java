...
public class BrownBubble extends SpriteBillboardParticle {
    private BrownBubble(ClientWorld world, double x, double y, double z, double d, double e, double f) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            com.codeetoasty.colwater.particle.BrownBubble BrownBubble = new com.codeetoasty.colwater.particle.BrownBubble(clientWorld, d, e, f, g, h, i);
            BrownBubble.setSprite(this.spriteProvider);
            return BrownBubble;
        }
    }
}
