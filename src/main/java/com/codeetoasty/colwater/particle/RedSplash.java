...
public class RedSplash extends RainSplashParticle {
    protected RedSplash(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
        super(world, x, y, z);
    ...
    public static class SplashFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            RedSplash testSplash = new RedSplash(clientWorld, d, e, f, g, h, i);
