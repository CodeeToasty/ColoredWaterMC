...
public class GreenBubble extends SpriteBillboardParticle {
    private GreenBubble(ClientWorld world, double x, double y, double z, double d, double e, double f) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            com.codeetoasty.colwater.particle.GreenBubble GreenBubble = new com.codeetoasty.colwater.particle.GreenBubble(clientWorld, d, e, f, g, h, i);
            GreenBubble.setSprite(this.spriteProvider);
            return GreenBubble;
        }
    }
}
