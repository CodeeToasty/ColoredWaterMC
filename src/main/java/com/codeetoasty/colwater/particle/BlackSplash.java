...
public class BlackSplash extends RainSplashParticle {
    protected BlackSplash(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
        super(world, x, y, z);
    ...
    public static class SplashFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            BlackSplash testSplash = new BlackSplash(clientWorld, d, e, f, g, h, i);
