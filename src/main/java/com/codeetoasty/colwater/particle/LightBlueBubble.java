...
public class LightBlueBubble extends SpriteBillboardParticle {
    private LightBlueBubble(ClientWorld world, double x, double y, double z, double d, double e, double f) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            com.codeetoasty.colwater.particle.LightBlueBubble LightBlueBubble = new com.codeetoasty.colwater.particle.LightBlueBubble(clientWorld, d, e, f, g, h, i);
            LightBlueBubble.setSprite(this.spriteProvider);
            return LightBlueBubble;
        }
    }
}
