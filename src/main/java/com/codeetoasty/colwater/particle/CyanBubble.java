...
public class CyanBubble extends SpriteBillboardParticle {
    private CyanBubble(ClientWorld world, double x, double y, double z, double d, double e, double f) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            com.codeetoasty.colwater.particle.CyanBubble CyanBubble = new com.codeetoasty.colwater.particle.CyanBubble(clientWorld, d, e, f, g, h, i);
            CyanBubble.setSprite(this.spriteProvider);
            return CyanBubble;
        }
    }
}
