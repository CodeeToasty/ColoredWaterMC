...
public class YellowBubble extends SpriteBillboardParticle {
    private YellowBubble(ClientWorld world, double x, double y, double z, double d, double e, double f) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            com.codeetoasty.colwater.particle.YellowBubble YellowBubble = new com.codeetoasty.colwater.particle.YellowBubble(clientWorld, d, e, f, g, h, i);
            YellowBubble.setSprite(this.spriteProvider);
            return YellowBubble;
        }
    }
}
