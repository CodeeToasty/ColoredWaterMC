...
public abstract class GlowWhiteWater extends DyableWater {
    ...
    public Fluid getStill() {
        return ModFluids.GLOW_STILL_WHITE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.GLOW_FLOWING_WHITE;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.GLOW_WHITE_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState fluidState) {
        // getBlockStateLevel converts the LEVEL_1_8 of the fluid state to the LEVEL_15 the fluid block uses
        return ModBlocks.GLOW_WHITE.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
    ...
    public static class Still extends GlowWhiteWater {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
